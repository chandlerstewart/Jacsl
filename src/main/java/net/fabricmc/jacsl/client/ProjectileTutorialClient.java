package net.fabricmc.jacsl.client;


import net.fabricmc.api.ClientModInitializer;
import net.fabricmc.fabric.api.client.rendereregistry.v1.EntityRendererRegistry;
import net.fabricmc.fabric.api.network.ClientSidePacketRegistry;
import net.fabricmc.jacsl.entity.EntitySpawnPacket;
...
public class ProjectileTutorialClient implements ClientModInitializer {
   ...
   public void onInitializeClient() {
       EntityRendererRegistry.INSTANCE.register(main.PackedSnowballEntityType, (dispatcher, context) ->
